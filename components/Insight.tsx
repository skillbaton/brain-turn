        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold text-gray-900">
              必要なのは、教育ではなく<br />
              <span className="text-navy-900">「管理構造」</span>。
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-[1fr_auto_1fr] gap-4 md:gap-6 items-center">
            ...
            <div className="card p-7 border-dashed border-2 border-gray-200 bg-gray-50/60">
              <div className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">現状</div>
              <p className="text-sm font-semibold text-gray-700 mb-4">教育は実施されています。</p>
              <p className="text-xs text-gray-400 mb-3">しかし…</p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-2.5 text-[13px] text-gray-500">
                    <span className="w-5 h-5 rounded-full bg-gray-200 flex-shrink-0 flex items-center justify-center">
                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                        <path d="M3 5h4" stroke="#9ca3af" strokeWidth="1.4" strokeLinecap="round"/>
                      </svg>
                    </span>
                    {item} — <em className="text-gray-400">把握できていない</em>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="flex md:hidden items-center justify-center my-2">
              <div className="w-10 h-10 rounded-full bg-navy-900 flex items-center justify-center shadow-md rotate-90">
            ...
            {/* After */}
            <div className="card p-7 border-2 border-navy-200 bg-white">
              <div className="text-xs font-semibold text-navy-900 uppercase tracking-widest mb-4">SKILL TUNEで</div>
              <p className="text-base font-semibold text-gray-900 leading-snug mb-5">
                理解されている状態を<br />管理できるようにします。
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5 text-[13px] text-gray-600">
                    <span className="mt-0.5 w-4 h-4 rounded-full bg-navy-900 flex-shrink-0 flex items-center justify-center">
