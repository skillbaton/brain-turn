        ...
        <div className="md:hidden bg-white border-t border-gray-100 px-5 py-4 space-y-1">
          ...
          <div className="pt-4 border-t border-gray-100 space-y-2">
            <div className="flex items-center gap-3 py-1.5">
              <a href="https://skill-tune.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 hover:text-gray-700 transition-colors">システムログイン</a>
            </div>
            <a
              href="#contact"
              onClick={() => setMenuOpen(false)}
